    ...
    for epoch in range(args.epochs):
        ...
        for edge_id, current_edge_clients in edge_clients_map.items():
            ...
            if len(client_weights) > 0:
                ...
                edge_logs.append(
                    "  --> [Edge {:02d}] clients={} loss={:.4f} core={:.3f} recover={:.3f} train={:.3f} trigger={:.0f}".format(
                        edge_id + 1,
                        len(client_weights),
        ...
        log_metric = (
            ...
            "Train Loss: {:.4f} | CoreClean: {:.3f} | Recover: {:.3f} | TrainRatio: {:.3f} | RecoveryTrigger: {:.0f}"
        ).format(
            global_test_acc,
            global_test_loss,
            aux_apa,
